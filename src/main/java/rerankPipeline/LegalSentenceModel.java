...
public class LegalSentenceModel 
    ...
    static {
        ...
        POSSIBLE_STOPS.add("!");
        POSSIBLE_STOPS.add("?");
        POSSIBLE_STOPS.add(";"); // XXX stop of citations
        POSSIBLE_STOPS.add(")");
        POSSIBLE_STOPS.add(".)");
        POSSIBLE_STOPS.add("\"");
        POSSIBLE_STOPS.add("''");
    ...
    static {
        ...
        // according to legal
        IMPOSSIBLE_PENULTIMATES.add("v"); // vs often turned to v
        IMPOSSIBLE_PENULTIMATES.add("etc");
        IMPOSSIBLE_PENULTIMATES.add("Ex");
        IMPOSSIBLE_PENULTIMATES.add("Fed");
        IMPOSSIBLE_PENULTIMATES.add("Cl");
        IMPOSSIBLE_PENULTIMATES.add("U.S");
     ...
     */
    public static final LegalSentenceModel INSTANCE
        = new LegalSentenceModel();
    ...
    static class Serializer extends AbstractExternalizable {
        ...
        public Object read(ObjectInput in) {
            return LegalSentenceModel.INSTANCE;
        }
    }
}
